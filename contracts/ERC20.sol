...
contract ERC20 {
    ...
    function transfer(address payable to, uint256 value) external returns(bool){
        ...
        payable(msg.sender).transfer(to, value);// does it revert automatically if it fails?
    }
    ...
    function approve(address spender, uint256 value) external returns(bool){
        ...
        allowances[msg.caller][spender] = value;

        emit Approval(msg.caller, spender, value);
